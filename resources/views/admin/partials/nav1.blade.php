<nav class="navbar navbar-expand-sm navbar-dark bg-dark fixed-top">
    ...
    <div id="my-nav" class="collapse navbar-collapse">
        <ul class="navbar-nav mr-auto">
            ...
            <a class="nav-link btn btn-success" href="{{'/'}}">ir a la Tienda<span class="sr-only ">(current)</span></a>
            </li>
            <li class="nav-item active">
            <a class="nav-link btn btn-success" href="{{url('/admin/home')}}" >inicio<span class="sr-only ">(current)</span></a>
            </li>
            {{-- <li class="nav-item active">
